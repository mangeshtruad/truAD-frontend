  ...
  return (
    <div className='confirm-container'>
        ...
        <form>
            ...
            <img src={showNewPass ? pass_show : pass_hide} onClick={() => setShowNewPass(!showNewPass)}></img>
            </label>
              <input
            ...
            <label className='confirmPass'>Confirm New Password
            <img src={showConfirmPass ? pass_show : pass_hide} onClick={() => setShowConfirmPass(!showConfirmPass)}></img>
            </label>
              <input
